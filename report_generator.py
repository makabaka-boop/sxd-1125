...
def generate_html_report(hours_threshold=30.0, load_threshold=20.0, coverage_threshold=3) -> str:
    ...
    html = _build_html(df, daily, personnel, region, warnings, hours_threshold, load_threshold, coverage_threshold)
...
def _build_html(df, daily, personnel, region, warnings, hours_th, load_th, cov_th):
